...
class Flickr
  ...
  def call(method, params)
    #res = Net::HTTP.get(URI.parse("http://api.flickr.com/services/rest/?method=flickr.photos.#{method}&api_key=e606900de034115b34006a4dcf2c5766&user_id=57794886@N00#{params.collect{|k,v|"&#{k}=#{v}"}}"))
    res = Net::HTTP.get(URI.parse("http://api.flickr.com/services/rest/?method=flickr.photos.#{method}&api_key=e606900de034115b34006a4dcf2c5766&user_id=58821970@N00#{params.collect{|k,v|"&#{k}=#{v}"}}"))
